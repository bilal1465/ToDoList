    ...
    return (
        ...
        <form onSubmit={done} className="flex flex-col items-center w-1/2 h-1/2 bg-green-300 rounded justify-center pt-5">
            ...
            <div className="flex flex-col w-full space-y-2 h-2/5">
                ...
                <input type="text" placeholder="Title" name="title" value={formData.title} onChange={handleChange} className="w-1/2 rounded border border-black pl-1"/>
                <PrioritySelection/>
                </div>
                <div className="flex flex-row h-1/4 space-x-2">
                <input type="text" placeholder="Time" name="time" value={formData.time} onChange={handleChange} className="w-1/2 rounded border border-black pl-1"/>
            ...
            <div className="flex w-full h-1/2 pt-2">
                <textarea placeholder="Description" name="description" value={formData.description} onChange={handleChange} className="resize-none w-full rounded border border-black pl-1"></textarea>
            </div>
            </div>
